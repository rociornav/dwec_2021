...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $data = json_decode($_POST["objeto"], false); //como lo tiene el profe
    //$data = json_decode(file_get_contents("php://input"), false);//asi se le pasa el body (version bien hecha)
