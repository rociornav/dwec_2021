...
function sacaNumeroNuevo(numeros_sacados) {
  ...
  if (!compruebaBingo(carton, numeros_sacados)) {
    ...
    document.getElementById("numero_actual").innerHTML = nuevo_numero;
    document.getElementById("numeros_pasados").innerHTML = numeros_sacados;
    document.getElementById("partida").innerHTML = "¡INICIO DE PARTIDA! números sacados - " + numeros_sacados.length;
  }else{
    document.getElementById("partida").innerHTML = "¡FIN DE PARTIDA!";
      document.getElementById("resultados").innerHTML = "¡BINGO!";
  }
